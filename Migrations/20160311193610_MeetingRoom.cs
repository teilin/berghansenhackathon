...
namespace BergHansenHackathon.Migrations
{
    public partial class MeetingRoom : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetingRoomId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityRole_RoleId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_ApplicationUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropColumn(name: "Etternavn", table: "AspNetUsers");
            migrationBuilder.DropColumn(name: "Fornavn", table: "AspNetUsers");
            migrationBuilder.DropTable("Availability");
            migrationBuilder.DropTable("MeetingRoom");
            migrationBuilder.AlterColumn<string>(
                name: "UserId",
                table: "AspNetUserLogins",
                nullable: true);
